...
config :isomorphic_site, IsomorphicSiteWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: IsomorphicSiteWeb.ErrorHTML, json: IsomorphicSiteWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: IsomorphicSite.PubSub,
  live_view: [signing_salt: "zjBYV/3h"]
...
config :tailwind,
  ...
  isomorphic_site: [
    ...
    cd: Path.expand("../apps/isomorphic_site", __DIR__)
  ]
